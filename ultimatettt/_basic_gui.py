...
class GraphicInterface():
    ...
    def create_layout(self):
        ...
        # visible=True
        layout.append([sg.Text(X_TURN_STR, key='textPlayerTurn', visible=False)])
        # visible=True
        layout.append([sg.Text('', key='textException', visible=False)])

        # visible=True
        layout.insert(0, [sg.Button('New game', visible=False), sg.Button('Exit', visible=False)])
